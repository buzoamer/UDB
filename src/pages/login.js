            ...
            <div className="bg-purple-600 bg-opacity-50 p-16 m-2 rounded-lg shadow-lg shadow-pink-800">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex items-center">
                  <button type="submit" className="bg-pink-600 text-white text-center px-2 py-2 rounded hover:bg-pink-900">Submit</button>
                    <span className="text-white text-md px-4 text-center"> Not registered?
